    ...
    public function run(): void
    {
        ...
        $sectors = [
            ...
            [
                ...
                'icon_key' => 'landmark',
                'summary' => 'Perbankan, asuransi, dan layanan pembiayaan yang berlandaskan prinsip syariah.',
            ...
            [
                ...
                'icon_key' => 'coins',
                'summary' => 'Penguatan zakat, infaq, sedekah, dan wakaf untuk pembangunan yang inklusif.',
                'content' => '<p>Direktorat Keuangan Sosial Syariah mempunyai tugas melaksanakan penyusunan rekomendasi, penyiapan, perumusan dan pelaksanaan koordinasi, serta pelaksanaan pemantauan dan evaluasi arah kebijakan dan program strategis di bidang keuangan sosial syariah.</p>
                             ...
                             <ul>
                                ...
                                <li><strong>Divisi Pengembangan Wakaf</strong>, yang mempunyai tugas melakukan penyiapan bahan rumusan rekomendasi, bahan koordinasi perumusan dan pelaksanaan, serta bahan pemantauan dan evaluasi arah kebijakan dan program strategis di bidang transformasi wakaf uang, optimalisasi aset wakaf produktif, peningkatan transparansi and akuntabilitas pengelolaan wakaf serta pengembangan instrumen wakaf untuk pembangunan berkelanjutan.</li>
                             </ul>',
                'sort_order' => 3,
            ],
            [
            ...
            [
                ...
                'icon_key' => 'network',
                'summary' => 'Arah pengembangan riset, kawasan, teknologi, dan jejaring kelembagaan halal.',
        ...
        foreach ($sectors as $item) {
            SectorItem::updateOrCreate(['slug' => $item['slug']], $item + ['is_active' => true]);
        }
